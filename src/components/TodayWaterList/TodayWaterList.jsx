...
const TodayWaterList = () => {
  ...
  return (
    <div className={styles.todayWaterListBox}>
      ...
      <div className={styles.waterListBox}>
        {loading ? (
          <p>Loading...</p>
        ):(
        ...
        <div>
          <button onClick={() => setIsOpenAddWaterModal(!isOpenAddWaterModal)} className={styles.AddWaterModalBtn}>
          ...
          {isOpenAddWaterModal && <WaterRadioPanel/>}
        </div>
    </div>
  )
}
